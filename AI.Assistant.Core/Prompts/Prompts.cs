...
public static class Prompts
{
    ...
    public static string SystemSeparator { get; } = LoadSystemSeparator();
    ...
    private static string LoadSystemSeparator()
    {
        var filePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Prompts", "system_separator.txt");
